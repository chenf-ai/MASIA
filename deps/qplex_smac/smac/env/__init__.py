...
from smac.env.starcraft2.simplified_starcraft2 import SimplifiedStarCraft2Env
...
# from smac.env.lbforaging import ForagingEnv

__all__ = ["MultiAgentEnv", "StarCraft2Env", "SimplifiedStarCraft2Env", "Matrix_game1Env", "Matrix_game2Env", "Matrix_game3Env", "mmdp_game1Env"]
